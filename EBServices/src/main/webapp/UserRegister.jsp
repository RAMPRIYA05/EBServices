...
<br>Email Id:<input type="email" placeholder="Enter your EmailId" name="emailId" required><br>
<br>Password:<input type="password" placeholder="Enter your Password" name="password" required><br>
 ...
 <br>Phone Number:<input type="tel" placeholder="Enter your Phone Number" name="phoneNumber" required><br>
 <br>Aadhaar Number:<input type="text" placeholder="Enter your Aadhaar Number" name="aadhaarNumber" required><br>
